...
print(f'{Fore.LIGHTCYAN_EX}Binary seed: {Style.RESET_ALL}'+binaryseed)
print(' ')
...
print(f'{Fore.LIGHTCYAN_EX}Checksum in binary: {Style.RESET_ALL}' + checksum_short_binary)
print(' ')

# Add binary checksum to binary seed
seed_with_checksum = binaryseed + checksum_short_binary
print(f'{Fore.LIGHTCYAN_EX}Seed with checksum: {Style.RESET_ALL}' + seed_with_checksum)
print(' ')
...
if var1 == 'Y' or var1 == 'y':
    ...
    print(f'{Fore.RED}Your seed did not get stored as textfile.{Style.RESET_ALL}')

# End
print(' ')
print(f'{Fore.GREEN}Thanks for using Chess-Wallet{Style.RESET_ALL}')
print(' ')
print(' ')
var2 = input(f'{Fore.RED}The program will now close itself. Hit enter to confirm{Style.RESET_ALL}')
print(' ')